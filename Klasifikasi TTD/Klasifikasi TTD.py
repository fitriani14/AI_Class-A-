...
# Fungsi untuk membaca gambar dan ekstrak fitur
    ...
    for label_folder in os.listdir(folder):
        ...
        if os.path.isdir(label_path):
            for filename in os.listdir(label_path):
                ...
                if img is not None:
                    # Resize gambar agar seragam (misalnya 128x128)
                    img = cv2.resize(img, (128, 128))
                    # Ekstrak fitur (misal, rata-rata intensitas pixel)
...
data_folder = "Klasifikasi TTD/TANDA TANGAN KELAS A"
...
image_path = "Klasifikasi TTD/Gambar test/Fitri.jpg"
